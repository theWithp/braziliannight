        ...
        if (o instanceof OBJIndex)
          {
            ...
            return index.normalIndex == normalIndex && index.positionIndex == positionIndex
                && index.texCoordsIndex == texCoordsIndex;
          }
              ...
              if (line != null && !line.trim().equals(""))
                {
                  ...
                  if (parts[0].equals(COMMENT))
                    ...
                    {
                      normals.add(new Vector3f(Float.parseFloat(parts[1]), Float.parseFloat(parts[2]),
                          Float.parseFloat(parts[3])));
