...
@OnlyIn(Dist.CLIENT)
public class ModelCreatureBase extends EntityModel<BNEntity> {
    ...
    // ==================================================
   	...
   	// ==================================================
    @Override
    public void render(BNEntity entity, float time, float distance, float loop, float lookY, float lookX, float scale) {
