...
public class ModelObjState
{
  ...
  // Attack Animation:
  /**
   * The current progress on an attack animation, increases to 1.0 and then
   * decreases back down to 0.0.
   **/
  ...
  /**
   * Set to true when the attack animation starts, set to false when finished,
   * prevents the attack from resetting mid animation.
   **/
  public boolean attackAnimationPlaying = false;
  /**
   * How much the animation progress increases or decreases by each tick. This
   * will have to count up to 1 and back down to 0 again.
   **/
